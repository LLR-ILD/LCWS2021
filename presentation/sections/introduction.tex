...
\begin{frame}
  ...
  \vfill
  \begin{enumerate}
    \item Build a sample with all Higgs decay modes
  ...
  \only<1>{\includegraphics[height=0.85\textheight, width=0.95\textwidth, keepaspectratio]
      {plot_factory/intro_sample_counts}}
  \only<2>{\addtocounter{framenumber}{1} \includegraphics[height=0.85\textheight, width=0.95\textwidth, keepaspectratio]
      {plot_factory/intro_signal_composition_per_category}}
  \only<3>{\addtocounter{framenumber}{1} \includegraphics[height=0.85\textheight, width=0.95\textwidth, keepaspectratio]
      {plot_factory/intro_category_counts}}
  \only<4>{\addtocounter{framenumber}{1} \includegraphics[height=0.85\textheight, keepaspectratio]
